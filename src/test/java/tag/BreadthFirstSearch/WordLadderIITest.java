...
class WordLadderIITest {
    ...
    void test() {
        ...
        List<List<String>> list = wordLadderII.findLadders(beginWord, endWord, wordList);
...
//        [[a, c]]
    ...
    void test2() {
        ...
        String endWord = "tax";
        List<String> wordList = new ArrayList<>(List.of("ted", "tex", "red", "tax", "tad", "den", "rex", "pee"));
        List<List<String>> list = wordLadderII.findLadders(beginWord, endWord, wordList);
